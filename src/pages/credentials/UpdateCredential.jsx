...
export default function UpdateCredential() {
    ...
    const { register, handleSubmit, reset, watch, formState: { errors } } = useForm({
        defaultValues: { title: '', username: '', password: '', website: '', notes: '', tags: '' }
    });
    ...
    return (
        <Box component="main" sx={{ backgroundColor: "primary.main", display: "flex", flexDirection: "column", px: { xs: 2, sm: 3 }, pt: 1, pb: 5 }}>
            ...
            <Box display="flex" justifyContent="center">
                <Box component="form" onSubmit={handleSubmit(onSubmit)} aria-label={t('Update Credential')}
                    ...
                    <Box display="flex" alignItems="center" gap={1.5}>
                        ...
                        <Box>
                            <Typography component="h1" variant="h6" sx={{ color: "white", fontWeight: "bold" }}>{t('Update Credential')}</Typography>
                    ...
                    <TextField
                        {...register("title", {
                            ...
                            validate: value => value.trim() !== '' || t('Title cannot be empty')
                        })}
                        id="title" fullWidth placeholder={t('e.g. Google, Netflix, Work Email')} variant="outlined"
                    ...
                    <TextField
                        {...register("username", {
                            ...
                            validate: value => value.trim() !== '' || t('Username cannot be empty')
                        })}
                        id="username" fullWidth placeholder={t('Username or email')} variant="outlined"
                    ...
                    <TextField
                        {...register("password", {
                            ...
                            validate: value => value.trim() !== '' || t('Password cannot be empty')
                        })}
                        id="password" fullWidth placeholder="••••••••" type={showPassword ? "text" : "password"} variant="outlined"
                            ...
                            endAdornment: (
                                <InputAdornment position="end">
                                    <IconButton onClick={() => setShowPassword(p => !p)} aria-label={showPassword ? 'Hide password' : 'Show password'}>
                                        {showPassword ? <Visibility aria-hidden="true" sx={{ color: 'secondary.main' }} /> : <VisibilityOff aria-hidden="true" sx={{ color: 'secondary.main' }} />}
                                    </IconButton>
                    ...
                    <TextField {...register("website")} id="website" fullWidth placeholder="https://example.com" variant="outlined"
                    ...
                    <TextField {...register("notes")} id="notes" fullWidth placeholder={t('Write a note...')} variant="outlined"
                    ...
                    <TextField {...register("tags")} id="tags" fullWidth placeholder={t('Write tags...')} variant="outlined"
                    ...
                    <Button type="submit" fullWidth disabled={isPending}
                        ...
                        {isPending ? <CircularProgress size={22} aria-label="Loading" sx={{ color: "primary.main" }} /> : t('Update Credential')}
                    </Button>
                </Box>
            </Box>
        </Box>
