        ...
        <Box sx={{
          ...
          <Box display="flex" flexDirection="column" gap={1} mb={2}>
            <Box display="flex" alignItems="center" gap={1.5}>
              ...
              <Box>
                <Typography sx={{ color: 'white', fontWeight: 600, fontSize: 22 }}>Sign Up</Typography>
                <Typography sx={{ color: 'rgba(255,255,255,0.4)', fontSize: 12 }}>
                  {step === 1 ? 'Create your secure account' : 'Enter the code sent to your email'}
                </Typography>
              </Box>
            </Box>
          ...
          <Box component="form" onSubmit={handleSubmit(RegisterForm)}
            ...
            {step === 2 && (
              <Box>
                <Typography sx={{ color: 'secondary.dark', fontSize: 12.5, mb: 0.5 }}>Verification Code</Typography>
                <TextField fullWidth placeholder="6-digit code" value={code}
            ...
            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.5)', textAlign: 'center', mt: 1 }}>
              ...
              <Link underline="none" sx={{ color: 'secondary.dark', fontWeight: 600 }}>Terms</Link>{' '}and{' '}
              <Link underline="none" sx={{ color: 'secondary.dark', fontWeight: 600 }}>Privacy Policy</Link>
            </Typography>
            ...
            {step === 1 && (
              <Button onClick={handleSendCode} disabled={codePending} sx={{
                ...
                {codePending ? <CircularProgress size={24} sx={{ color: 'white' }} /> : 'Send Verification Code'}
              </Button>
            )}
