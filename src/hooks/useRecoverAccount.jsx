            ...
            await Swal.fire({
                ...
                html: `
                    ...
                    <div style="
                        ...
                        color:rgb(53,241,119);letter-spacing:2px;
                    ...
                    ">
                        If you lose this key and your password, your data cannot be recovered.
                    </div>
                    <div style="display:flex;justify-content:center;gap:10px">
                        <button id="copyBtn" style="
                            background:rgba(53,241,119,0.15);
                            border:1px solid rgba(53,241,119,0.3);
                            padding:8px 16px;border-radius:8px;
                            color:rgb(53,241,119);cursor:pointer;font-weight:600;font-size:13px
                        ">Copy</button>
